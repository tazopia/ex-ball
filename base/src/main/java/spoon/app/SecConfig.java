...
public class SecConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(Config.getPathSeller() + "/**").access("hasRole('ROLE_AGENCY1') or hasRole('ROLE_AGENCY2')")
                .antMatchers(Config.getPathSite() + "/**").access("hasRole('ROLE_USER') or hasRole('ROLE_DUMMY')")
                .anyRequest()
                .authenticated()
