...
public class GameConfig {
    ...
    private double[] noHitSportsOdds = {0, 5, 4, 3, 2, 1, 1, 1, 1, 1, 1};
    private double[] noHitSportsRecommOdds = {0, 2.5, 2, 1.5, 1, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5};
    private double[] noHitZoneOdds = {0, 5, 4, 3, 2, 1, 1, 1, 1, 1, 1};
    private double[] noHitZoneRecommOdds = {0, 2.5, 2, 1.5, 1, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5};
