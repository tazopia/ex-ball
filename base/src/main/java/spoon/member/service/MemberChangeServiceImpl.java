...
public class MemberChangeServiceImpl implements MemberChangeService {
    ...
    public List<String> addMember(String memberText) {
        ...
        for (String line : lines) {
            ...
            String[] fields = Arrays.copyOf(line.trim().split("\\t"), 21);
            ...
            try {
                ...
                user.setAgency2(fields[14]);
                user.setAgency1(fields[15]);
                user.setJoinDate(DateUtils.parse(fields[16].substring(0, 19), "yyyy-MM-dd HH:mm:ss"));
                if ("정상".equals(fields[17])) {
                ...
                user.setLoginDate(DateUtils.parse(fields[18].substring(0, 19), "yyyy-MM-dd HH:mm:ss"));
                user.setMemo(fields[20]);
